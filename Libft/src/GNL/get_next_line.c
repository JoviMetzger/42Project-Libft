...
/*   Updated: 2025/02/16 12:07:06 by jmetzger      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
//GET_NEXT_LINE_UTILS
static int	gnl_strchr(char *str)
{
	if (!str)
		return (0);
	while (*str)
 ...
 */
static char	*add_to_stash(char *stash)
{
	char	*line;
	int		i;
 ...
 */
static char	*read_and_stash(int fd, char *stash, char *read_file, char *str)
{
	int	read_bytes;
